$(document).ready(function () {
    $('#id_password1').blur(checkPassword).keyup(checkPassword).change(checkPassword);
    $('#id_password2').blur(checkPassword).keyup(checkPassword).change(checkPassword);
...
function checkPassword() {
    if ($('#id_password1').val().trim().length > 0 && $('#id_password2').val().trim().length > 0) {
        ...
        $("#password_info").remove();
        $('#id_password1').removeClass('input_valid input_invalid');
        $('#id_password2').removeClass('input_valid input_invalid');
    }
}
...
function checkEmail() {
    ...
    if ($('#id_email').val().trim().length > 0) {
        ...
        $("#email_info").remove();
        $('#id_email').removeClass('input_valid input_invalid');
    }
}
